...
from mov.humanize import naturalsize
...
class CreateForm(forms.ModelForm):
    ...
    class Meta:
        model = Movie
        fields = ['title', 'review', 'tags', 'picture']  # Picture is manual
    ...
    def clean(self):
        ...
        if pic is not None and len(pic) > self.max_upload_limit:
            self.add_error(
                'picture',
                "File must be < " + self.max_upload_limit_text + " bytes"
            )

        return cleaned_data   # ✅ ALWAYS return this
